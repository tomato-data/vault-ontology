...
문서는 표현물이고, 지식 개체는 문서가 표현하는 대상이다. Phase 11은 이 둘의
정체성과 수명 주기를 분리한다.
...
Phase 6의 IRI는 파일 경로를 안정적으로 되돌리는 문제였다. Phase 11의 ID는 편집·이동·
...
>   ID 정책은 사실상 되돌릴 수 있다. **Phase 10.5·13에 시간을 더 쓴다.**
