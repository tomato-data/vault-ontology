...
- **모든 대역이 판단을 담고 있지는 않다.** 실측 결과 `601 Books`의 챕터 필사
  ...
  ([`competency-questions.md`](competency-questions.md)의 실측 절).
...
> 당긴 이유, 종착점을 Phase 17로 둔 이유, 900·100 대역의 참여 방식이 거기 있다.
>
> **Phase 10 산출물** — [`competency-questions.md`](competency-questions.md)(질문 30개·전수 판정) ·
...
| **10.5** | [phase10-5](phase10-5.md) | 라벨링 파일럿 8~10개 | 문서당 15분 · 재라벨링 일치 60% | 낮음 |
...
**3부는 Phase 17에서 끝난다.** 읽기 전용 도구까지 만들고 멈춘다.

| 보류 | 가이드 | 다시 판단하는 시점 |
|---|---|---|
| **18** | [phase18](phase18.md) | 제안·승인·철회 workflow — Phase 17의 2주 실사용 결과를 본 뒤 |
| **19** | [phase19](phase19.md) | 제한된 지식 운영 — 18이 정당화되지 않으면 시작하지 않는다 |
